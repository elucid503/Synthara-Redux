...
func Volume(Event *events.ApplicationCommandInteractionCreate) {
	...
	Event.CreateMessage(discord.MessageCreate{
		...
		Embeds: []discord.Embed{Utils.CreateEmbed(Utils.EmbedOptions{
			...
			Title:       Localizations.Get("Commands.Volume.Title", Locale),
			Author:      Localizations.Get("Embeds.Categories.Playback", Locale),
			Description: Localizations.GetFormat("Commands.Volume.Description", Locale, Guild.Features.Volume),
			Color:       Utils.PRIMARY,
