...
func DeleteAutocomplete(Event *events.AutocompleteInteractionCreate) {
	...
	Choices := []discord.AutocompleteChoice{
		...
		discord.AutocompleteChoiceString{
			...
			Name:  Localizations.Get("Autocomplete.Delete.All", Locale),
			Value: "ALL",
	...
	if len(Choices) == 1 { // Only "ALL" option

		Event.AutocompleteResult([]discord.AutocompleteChoice{

			discord.AutocompleteChoiceString{

				Name:  Localizations.Get("Autocomplete.Delete.NoActiveGuilds", Locale),
				Value: "none",
